...
-- pinning_command    = ""
-- pinning_command    = "tasksetcpulist=..."
-- pinning_command = "numactl --physcpubind=0,2,4,6"
...
-- run_directory  = "."
run_directory  = "/userdir/home/fsantoro/saturne/saturne-open-cases/BUNDLE/BENCH_C016_01/"
